...
import { deleteGallery } from '@/action/gallery'
          ...
          <div className="sm:col-span-2">
            <div className="flex flex-wrap items-center gap-1 mt-2">
              <Button
                ...
                size="small"
                icon={<EyeOutlined />}
                onClick={() => router.push(`/media/gallery/${gallery.galleryId}`)}
              >
                조회
              </Button>
              <Button
                ...
                size="small"
                icon={<EditOutlined />}
                onClick={() => router.push(`/media/gallery/update/${gallery.galleryId}`)}
              >
                수정
              </Button>
              <Button
                ...
                onClick={() => {
                  Modal.confirm({
                    ...
                    cancelText: '취소',
                    onOk: async () => {
                      const result = await deleteGallery(gallery.galleryId)
                      if (result.success) {
