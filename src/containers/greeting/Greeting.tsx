...
const Greeting = () => {
  return (
    <div
      className={
        "flex flex-col items-center w-[280px] sm:w-[400px] md:w-[800px] mb-[30px]"
      }
    >
      <h2
        className={
          "text-[10px] sm:text-[12px] md:text-[16px] text-[#999999] my-[20px]"
        }
      >
      ...
      <div
        className={
          "flex flex-col items-center mb-[10px] " +
      ...
      <div
        className={
          "flex flex-col items-center mt-[10px] mb-[30px] " +
          "text-[10px] sm:text-[12px] md:text-[18px]"
        }
      >
        <p>제주특별자치도 농구협회장</p>
        <p className={"font-bold mt-[5px]"}>김병주</p>
      </div>
      <div
        className={"text-[10px] sm:text-[12px] md:text-[18px] text-[#4B4B4B]"}
      >
        <p className={"mb-[10px]"}>
          안녕하십니까, 제주특별자치도 농구협회장입니다.
        </p>
        <p className={"mb-[10px]"}>
